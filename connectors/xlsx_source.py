...
class XlsxDataSource(DataSource):
    ...
    def insert_data(self, List[Dict[str, Any]], table_name: str):
    """
    ...
    """
    if self._is_read_only:
        raise Exception("Cannot insert  workbook opened in read-only mode.")
...
def update_data(self, updates: List[Dict[str, Any]], key_fields: List[str], table_name: str):
    ...
    """
    if self._is_read_only:
        raise Exception("Cannot update  workbook opened in read-only mode.")
...
def delete_data(self, deletions: List[Dict[str, Any]], key_fields: List[str], table_name: str):
    ...
    """
    if self._is_read_only:
        raise Exception("Cannot delete  workbook opened in read-only mode.")
...
def standard_formatting(self, List[Dict[str, Any]]
